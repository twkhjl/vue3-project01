...
<template>
    <div
        class="top-nav sticky top-0 h-[10vh] w-full z-10 px-4 bg-gray-400 shadow-md shadow-black flex justify-start items-center md:ml-[20vw] md:w-[80vw] md:mx-auto"
    >
        ...
        <div class="relative mr-0 mx-auto">
            ...
            <div
                ...
                :class="[
                    currentMenu == 'user' &&
                    !topNavStore.isTopNavSubMenuHidden()
                        ? ''
                        : 'hidden',
                ]"
                class="dropdown absolute right-1 top-[7vh] shadow-md shadow-black min-w-[50vw] md:min-w-[15vw] w-auto h-auto bg-[#e9e6e8]"
            >
                <div class="border-b-gray-400 border-2 text-gray-400 text-xl">
                    選單
                </div>
                ...
                <div
                    @click="logout()"
                    class="droppdown-item ml-2 my-2 text-lg cursor-pointer"
                >
