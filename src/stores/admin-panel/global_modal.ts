...
export const useGlobalModalStore = defineStore('global_modal', () => {
  ...
  let _callback_fn_arr: Array<callbackFnItem> = []
  ...
  interface callbackFnItem {
    fn: Function
    params: object
    is_async: boolean
  }
  function set_callback_fn_arr(callbackFnTiemArr: callbackFnItem[]) {
    _callback_fn_arr = callbackFnTiemArr
  }
  function get_callback_fn_arr() {
    return _callback_fn_arr
  }
  function exec_fn(fn: Function, ...params: any) {
    fn(...params)
  }
  async function exec_async_fn(async_fn: Function, ...params: any) {
    await async_fn(...params)
  }
