...
export const useGlobalModalStore = defineStore('global_modal', () => {
  ...
  return {
    ...
    use_alert, use_confirm,
    get_current_modal,


    enable_overlay, disable_overlay, is_overlay_enabled,
    enable_overlay_animation, disable_overlay_animation, is_overlay_animation_enabled,
    enable_modal_animation, disable_modal_animation, is_modal_animation_enabled,

    get_cancel_btn_text, set_cancel_btn_text,
    get_confirm_btn_text, set_confirm_btn_text,

    get_content, set_content,
    get_title, set_title,

    set_confirm_callback_fn, exec_confirm_callback_fn, exec_async_confirm_callback_fn,
    set_confirm_callback_type_async, set_confirm_callback_type_sync, is_confirm_callback_type_async,

    is_loading, start_loading, stop_loading,
  }
})
